...
#ifndef BAT_ADS_INTERNAL_ADS_BRAVE_TODAY_ADS_BRAVE_TODAY_AD_OBSERVER_H_
#define BAT_ADS_INTERNAL_ADS_BRAVE_TODAY_ADS_BRAVE_TODAY_AD_OBSERVER_H_
...
class BraveTodayAdObserver : public base::CheckedObserver {
 public:
  ...
  virtual void OnBraveTodayAdViewed(
      const BraveTodayAdInfo& ad) {}

  // Invoked when a Brave Today ad is clicked
  virtual void OnBraveTodayAdClicked(
      const BraveTodayAdInfo& ad) {}
...
#endif  // BAT_ADS_INTERNAL_ADS_BRAVE_TODAY_ADS_BRAVE_TODAY_AD_OBSERVER_H_
